...
- **Humanizer with Word-level Diff**: A T5-based paraphrasing engine that rewrites text. It features **word-level highlighting** (Red for removals, Green for additions) so you can see exactly how the AI improved the text.
...
### 1. Requirements
Ensure you have Python 3.9+ installed and, optionally, [Ollama](https://ollama.com/) for the Reasoning feature.

### 2. Install Dependencies
```powershell
pip install fastapi uvicorn python-multipart PyMuPDF python-docx transformers torch requests sentencepiece
```
...
- **Models Used**:
    ...
    - Humanizer: `Vamsi/T5_Paraphrase_Paws`
